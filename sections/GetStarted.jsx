      ...
      <div className="gradient-07 " />         
        <section className="glassmorphism-4 justify-start left-0  text-white absolute">
          ...
          className="container">
            ...
            <br3></br3>
            <h2 className="font1 sm:text-[24px] text-[20px]" style={{ textAlign:'center' }}> &nbsp;<span className="bold font1 sm:text-[26px] text-[22px]" style={{color:"hsla(295, 95%, 52%, 0.773)"}}> Research </span>And<span className="bold font1 sm:text-[26px] text-[22px]" style={{color:"hsla(295, 95%, 52%, 0.773)"}}> Development </span>Intern </h2>
            <h2 className="font1 sm:text-[22px] text-[17px]" style={{ textAlign:'center'}}>APRIL 2022 <b><span style={{color:"hsla(295, 95%, 52%, 0.773)"}}>•</span>··</b>·············<b>··<span style={{color:"hsla(295, 95%, 52%, 0.773)"}}>•</span></b>DEC 2022</h2>
            <p className="font1 sm:text-[22px] text-[17px]" style={{ textAlign:'center'}}> &nbsp;</p>
            <h2 className="font1 sm:text-[22px] text-[17px]" style={{ textAlign:'center' }}><b7>Tools and Technologies Used</b7></h2>
            <div className="hline-container" style={{ display: "flex", justifyContent: "center"}}>
              <div className="hline" style={{ width: "70%" }}></div>
